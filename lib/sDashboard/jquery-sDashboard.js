...
( function(factory) {"use strict";
		...
		$.widget("mn.sDashboard", {
			...
			_bindEvents : function() {
				...
				//click event for maximize or minimize button
				this.element.on("click",".sDashboardWidgetHeader span.ui-icon.ui-icon-circle-arrow-n",function(e) {
			...
			_constructWidget : function(widgetDefinition) {
				...
				var maximizeButton = $('<span title="Maximize" class="ui-icon ui-icon-circle-arrow-n"></span>');
				var largerButton = $('<span title="Maximize" class="ui-icon ui-icon-circle-plus"></span>');
				var smallerButton = $('<span title="Maximize" class="ui-icon ui-icon-circle-minus"></span>');
